...
pandoc -f org+smart -o paper.pdf paper.org --bibliography=bibliography.bib --filter=pandoc-crossref --citeproc --csl=harvard-dsh.csl --reference-location=document
